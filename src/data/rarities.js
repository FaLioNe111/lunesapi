...
export const RARITIES = {
  /* Безымянная — звёзды без имён: имя придумывает покупатель */
  nameless: {
    id: 'nameless',
    label: 'Безымянная',
    order: 0,
    price: 99,             // фиксированная цена категории, ₽
    tagline: 'ждёт, когда вы дадите ей имя',
    groupTagline: 'у этих звёзд ещё нет имён — имя своей звезде придумаете вы, и оно останется с ней навсегда',
  },
